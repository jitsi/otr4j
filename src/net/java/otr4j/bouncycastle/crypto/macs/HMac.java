package net.java.otr4j.bouncycastle.crypto.macs;

import java.util.Hashtable;

import net.java.otr4j.bouncycastle.crypto.CipherParameters;
import net.java.otr4j.bouncycastle.crypto.Digest;
import net.java.otr4j.bouncycastle.crypto.ExtendedDigest;
import net.java.otr4j.bouncycastle.crypto.Mac;
